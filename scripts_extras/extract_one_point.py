# Este script divide la imagen original y solo extrae la cara de las coordenadas que le pasamos. Recibe como parámetros las coordenadas de la cámara  y las coordenadas del elemento al que hay que apuntar
